...
public class DomRelQstTeach implements DatabaseSql {
	...
	public String getSql() {
		String sql = 
			...
			"SYS_TOPIC from dom_rel_qst_teach dk where dk.SYS_DOCUMENTID not in (select top " + DatabaseSql.PAGE_COUNT * this.currentPage + " SYS_DOCUMENTID from dom_rel_qst_teach dit order by dit.SYS_DOCUMENTID) order by dk.SYS_DOCUMENTID";
	...
	public String  getCount() {
		String sql = "select count(1) from dom_rel_qst_teach";
		return sql;
	}
