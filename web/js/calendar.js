...
var gsBottom = "<table border='0' cellspacing='0' cellpadding='0' align='center'><tr><td><input class='Today' type='button' value='清除' onclick='gdCtrl.value=\"\";if(this.blur)this.blur();fHideCal();return false;'></td><td width=60 align=center><input class='Today' type='button' value='今天' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"不可以选择今天！\");return false;'></td><td><input class='Today' type='button' value='关闭' onclick='fHideCal();return false;'></td></tr></table>";
